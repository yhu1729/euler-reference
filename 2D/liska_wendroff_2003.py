...
class Problem:
    def __init__(self, case_id, N_x, N_y):
        ...
        if self.case_id == 3:
            self.t_stop = 0.3
            self.rho = [[0.5323, 1.5], [0.138, 0.5323]]
            self.u = [[1.206, 0], [1.206, 0]]
            self.v = [[0, 0], [1.206, 1.206]]
            self.p = [[0.3, 1.5], [0.029, 0.3]]
        elif self.case_id == 4:
            self.t_stop = 0.25
            self.rho = [[0.5065, 1.1], [1.1, 0.5065]]
            self.u = [[0.8939, 0], [0.8939, 0]]
            self.v = [[0, 0], [0.8939, 0.8939]]
            self.p = [[0.35, 1.1], [1.1, 0.35]]
        elif self.case_id == 6:
            self.t_stop = 0.3
            self.rho = [[2, 1], [1, 3]]
            ...
            self.p = [[1, 1], [1, 1]]
        elif self.case_id == 12:
            self.t_stop = 0.25
            self.rho = [[1, 0.5313], [0.8, 1]]
            self.u = [[0.7276, 0], [0, 0]]
            self.v = [[0, 0], [0, 0.7276]]
            self.p = [[1, 0.4], [1, 1]]
        elif self.case_id == 15:
            self.t_stop = 0.2
            self.rho = [[0.5197, 1], [0.8, 0.5313]]
            self.u = [[-0.6259, 0.1], [0.1, 0.1]]
            self.v = [[-0.3, -0.3], [-0.3, 0.4276]]
            self.p = [[0.4, 1], [0.4, 0.4]]
        elif self.case_id == 17:
            self.t_stop = 0.3
            self.rho = [[2, 1], [1.0625, 0.5197]]
            self.u = [[0, 0], [0, 0]]
            self.v = [[-0.3, -0.4], [0.2145, -1.1259]]
            self.p = [[1, 1], [0.4, 0.4]]
        else:
